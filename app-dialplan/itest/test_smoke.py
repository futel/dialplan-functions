...
class TestDialers(TestCase):
    ...
    def test_dial_outgoing_e164_pstn(self):
        ...
        check_response(
            response,
            '<?xml version="1.0" encoding="UTF-8"?><Response><Dial action="https://stage.dialplans.phu73l.net/ops/call_status_outgoing" answerOnBridge="true" callerId="+19713512383"><Number>+15035551212</Number></Dial></Response>')
